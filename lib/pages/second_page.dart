            ...
            child: Column(
              ...
              children: [
                          ...
                          children: [
                            ...
                            const Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Deskripsi berita', style: TextStyle(fontSize: 12)),
                                  SizedBox(height: 4),
                  ...
                  children: List.generate(3, (index) {
                    return ListTile(
                      leading: ClipRRect(
                        ...
                        child: Image.asset('assets/images/foto2.jpg', height: 50, width: 50, fit: BoxFit.cover),
                      ),
                ...
                ListTile(
                  leading: ClipRRect(
                    borderRadius: BorderRadius.circular(8),
                    child: Image.asset('assets/images/foto_diri.jpg', height: 50, width: 50, fit: BoxFit.cover),
                  ),
                  title: const Text('Fadillah Ahmad Avicenna'),
